...
// HOC COMPONENT (Comp IN - Comp OUT)
  ...
  return (
    <span>
      <svg xmlns="http://www.w3.org/2000/svg" 
        ...
        <text y="115" font-size="5" font-weight="bold" font-family="'Helvetica Neue', Helvetica, Arial-Unicode, Arial, Sans-serif">Created by Luis Durazo</text><text y="120" font-size="5" font-weight="bold" font-family="'Helvetica Neue', Helvetica, Arial-Unicode, Arial, Sans-serif">from the Noun Project</text></svg>
    </span>
  )
}
